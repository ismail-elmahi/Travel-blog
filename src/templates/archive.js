...
const archive = (props) => {
    ...
    const prevPage = currentPage - 1 === 1 ? '/blog/all' : `/blog/all/${currentPage - 1}`
    const nextPage = `/blog/all/${currentPage + 1}`
            ...
            <header>
                <div className="archive__section">
                    ...
                    <div className="archive__nav">
                        <Link to="/blog/all" className={window.location.href.indexOf('/blog/all') > 0 ? 'archive__nav--link selected' : 'archive__nav--link'}>All</Link>
