    ...
    return (
        <nav>
            <div className="nav__items">
                ...
                <Link to="/blog/all" className={window.location.href.indexOf('blog/all') > 0 || window.location.href.indexOf('category') > 0 ? 'nav__item--link active': 'nav__item--link'}>Blog</Link>
